        ...
        <div>
          <div>
            ...
            <div className="text-gray-300 text-xl font-normal mb-8">
              ...
              <p className="lg:ml-7">
                Diseñé y programé un sistema automatizado para la exoneración de
                idiomas, basado en los resultados de exámenes, que permite la
                evaluación eficiente de los estudiantes.
              </p>
            </div>
            <div className="text-gray-300 text-xl font-normal mb-8">
              <strong className="flex items-center gap-4">
              ...
              <p className="lg:ml-7">
                ...
                los desarrolladores junior, donde he compartido conocimientos y
                experiencia con otros desarrolladores.
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          <div>
            ...
            <div className="text-gray-300 text-xl font-normal mb-8">
              ...
              <p className="lg:ml-7">
                Proyecto que tuvo como objetivo administrar las incidencias del
                día a día en el departamento de mantenimiento del hospital donde
                trabajaba. La aplicación no busca sustituir el sistema interno
                de incidencias del hospital, sino complementarse con el personal
                y reemplazar los mensajes de WhatsApp, ya que a menudo se
                pierden en la comunicación diaria.
              </p>
            </div>
            <div className="text-gray-300 text-xl font-normal mb-8">
              <strong className="flex items-center gap-4">
              ...
              <p className="lg:ml-7">
                ...
                administrador de turnos, un contador de entradas y salidas de un
                parqueo, un simulador de recargas de tarjetas del metro, entre
                otros.
              </p>
            </div>
            <div className="text-gray-300 text-xl font-normal mb-8">
              ...
              <p className="lg:ml-7">
                Estuve capacitando algunos estudiantes que requerian mejorar su
