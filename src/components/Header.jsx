...
const Header = () => {
  return (
    <div id="header" className="max-w-[75rem] mx-auto">
      ...
      <h1 className="font-black text-5xl mt-10 -mb-10 text-center text-red-300 animate__animated animate__fadeInDownBig">
        El portafolio se encuentra en proceso de construcción
      </h1>

      <div className="lg:flex lg:justify-evenly items-center mt-24 md:mt-64 mb-64">
        <div className="border md:w-[15rem] md:h-[15rem] w-[10rem] h-[10rem] mb-5 lg:mb-0 mx-auto lg:mx-0 rounded-full flex justify-center items-center overflow-hidden">
          <img
            className="w-full h-full object-cover animate__animated animate__fadeIn animate__slow"
            src="img/Fotomia.png"
            alt="imagen mia"
          />
        </div>
        ...
        <div className="flex flex-col">
          ...
          <section className="flex flex-wrap gap-5 text-white mt-10 lg:justify-start justify-center animate__shakeX animate__animated">
