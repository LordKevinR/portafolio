...
export function Card({ image1, image2, title, desc, width, height }) {
  return (
    <div className={`w-full ${width}`}>
      <div
        className={cn(
          `${height} group w-full cursor-pointer overflow-hidden relative card rounded-[2rem] shadow-xl mx-auto flex flex-col justify-end p-4 border border-transparent border-neutral-800`,
